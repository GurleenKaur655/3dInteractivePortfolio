...
import lighthouseScene from '../assets/3d/the_lighthouse-2.glb'
...
isRotating, setIsRotating, setCurrentStage, ...props
    ...
    const { nodes, materials } = useGLTF(lighthouseScene)
    ...
    const handleKeyDown = (e) => {
        if (e.key === 'ArrowLeft') {
            ...
            lighthouseRef.current.rotation.y += 0.01 * Math.PI;
...
//so the model loads before the component renders
